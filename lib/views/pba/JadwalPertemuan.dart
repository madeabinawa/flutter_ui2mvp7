...
class JadwalPertemuan extends StatefulWidget {
  @override
  _JadwalPertemuanState createState() => _JadwalPertemuanState();
}

class _JadwalPertemuanState extends State<JadwalPertemuan> {
  @override
  ...
  cancel() {
    return RaisedButton(
      ...
      onPressed: () => Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => FeedbackUser(feedbackType: 'cancel',),
        ),
      ),
    );
  }
